...
var vec__36532 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var self__ = this;
var self__ = this;
var G__36581 = (arguments.length - (1));
switch (G__36581) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args36573){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args36573)));
}));
...
var _STAR_always_update_STAR__orig_val__36732 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__36733 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__36733);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__36732);
}} else {
