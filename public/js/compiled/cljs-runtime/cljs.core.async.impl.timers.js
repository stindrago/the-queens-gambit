...
var i_32368 = (self__.level + (1));
while(true){
if((i_32368 <= (new_level + (1)))){
(update[i_32368] = self__.header);

var G__32371 = (i_32368 + (1));
i_32368 = G__32371;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32377 = (update[i]).forward;
(x__$2.forward[i] = (links_32377[i]));
...
var i_32385 = (0);
while(true){
if((i_32385 <= self__.level)){
var links_32386 = (update[i_32385]).forward;
if((x__$1 === (((i_32385 < links_32386.length))?(links_32386[i_32385]):null))){
(links_32386[i_32385] = (x__$1.forward[i_32385]));

var G__32387 = (i_32385 + (1));
i_32385 = G__32387;
continue;
} else {
var G__32389 = (i_32385 + (1));
i_32385 = G__32389;
continue;
}
} else {
