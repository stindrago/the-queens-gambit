...
var G__27957 = (i__4737__auto___27952 + (1));
i__4737__auto___27952 = G__27957;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27873){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27874,G__27875,seq27873__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27912_SHARP_){
return (!((cljs.core.meta(p1__27912_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27925__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27929){var _e__26585__auto__ = e27929;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e27931){var _e__26585__auto__ = e27931;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27937 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27938 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27938);

try{var map__27941 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27941__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27937);
}});
...
var temp__5733__auto___27971 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27971)){
var managed_print_level_27972 = temp__5733__auto___27971;
var _STAR_print_level_STAR__orig_val__27944_27973 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27945_27974 = managed_print_level_27972;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27945_27974);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27943_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27943_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27944_27973);
}} else {
job_fn();
}
