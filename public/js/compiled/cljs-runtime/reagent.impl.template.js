...
var G__37413 = o;
(G__37413[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__37460__i < G__37460__a.length) {G__37460__a[G__37460__i] = arguments[G__37460__i + 0]; ++G__37460__i;}
  args = new cljs.core.IndexedSeq(G__37460__a,0,null);
} 
return G__37459__delegate.call(this,args);};
G__37459.cljs$lang$maxFixedArity = 0;
G__37459.cljs$lang$applyTo = (function (arglist__37463){
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37419){
...
var props = map__37420__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37420__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37422){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37423__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__37428){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37429__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37429__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__37431 = jsprops;
(G__37431["defaultValue"] = value);

(G__37431["onChange"] = (function (p1__37425_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__37425_SHARP_);
}));
...
var vec__37433 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37433,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37433,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37433,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37494 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37494 == null)){
} else {
var key_37495 = temp__5739__auto___37494;
(jsprops["key"] = key_37495);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__37439){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37440__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__37442 = reagent.impl.template.__GT_NativeWrapper();
(G__37442["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__37443 = wrapped;
(G__37443["syntheticInput"] = true);

return G__37443;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__37444 = wrapped__$1;
(G__37444["syntheticOnChange"] = on_change);

return G__37444;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__37445 = wrapped__$2;
(G__37445["syntheticOnUpdate"] = on_update);
...
var len__4736__auto___37513 = arguments.length;
var i__4737__auto___37514 = (0);
while(true){
if((i__4737__auto___37514 < len__4736__auto___37513)){
args__4742__auto__.push((arguments[i__4737__auto___37514]));

var G__37515 = (i__4737__auto___37514 + (1));
i__4737__auto___37514 = G__37515;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37449){
var G__37450 = cljs.core.first(seq37449);
var seq37449__$1 = cljs.core.next(seq37449);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37450,seq37449__$1);
}));
...
break;
default:
var G__37523 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__37523;
continue;
...
var n__4613__auto___37524 = a.length;
var i_37525 = (0);
while(true){
if((i_37525 < n__4613__auto___37524)){
(a[i_37525] = reagent.impl.template.as_element((a[i_37525])));

var G__37526 = (i_37525 + (1));
i_37525 = G__37526;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___37527 = a.length;
var i_37528 = (0);
while(true){
if((i_37528 < n__4613__auto___37527)){
var val_37529 = (a[i_37528]);
if(((cljs.core.vector_QMARK_(val_37529)) && ((reagent.impl.template.key_from_vec(val_37529) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37528] = reagent.impl.template.as_element(val_37529));

var G__37530 = (i_37528 + (1));
i_37528 = G__37530;
continue;
} else {
}
...
var ctx = ({});
var vec__37453 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37453,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37453,(1),null);
...
var G__37456 = (cljs.core.count(argv) - first_child);
switch (G__37456) {
case (0):
