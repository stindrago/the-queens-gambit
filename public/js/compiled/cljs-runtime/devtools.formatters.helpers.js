...
var G__27869 = devtools.prefs.pref(v);
v = G__27869;
continue;
} else {
return v;
...
}catch (e27831){var _e__26585__auto__ = e27831;
return false;
}})();
...
}catch (e27835){var _e__26585__auto__ = e27835;
return false;
}})();
...
}catch (e27837){var _e__26585__auto__ = e27837;
return false;
}}
}
});
...
var vec__27854 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27854,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27854,(1),null);
...
return cljs.core.some((function (p1__27859_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27859_SHARP_);
}),template);
});
